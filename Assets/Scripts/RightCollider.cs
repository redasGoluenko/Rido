...
public class RightCollider : MonoBehaviour
{
    ...
    public void SpawnToken()
    {
        ...
        if (currentToken != null)
        {
            ...
            List<Vector3> potentialPositions = new List<Vector3> { topPosition, downPosition, rightPosition };
    ...
    public void SpawnTokenRedirect()
    {
        ...
        if (currentToken != null)
        {
            ...
            // Determine the spawn positions based on fixed offsets
            Vector3 leftPosition = spawnPosition + Vector3.up * 0.001f + Vector3.left * 2.5f;
            Vector3 topPosition = spawnPosition + Vector3.left * 1.5f + Vector3.up;
            Vector3 downPosition = spawnPosition + Vector3.down + Vector3.left * 1.5f;

            // List of potential spawn positions
            List<Vector3> potentialPositions = new List<Vector3> { leftPosition, topPosition, downPosition };
